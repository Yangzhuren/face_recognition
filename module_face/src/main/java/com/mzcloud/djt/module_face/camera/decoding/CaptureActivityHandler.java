...
import com.mzcloud.djt.module_face.camera.view.ViewfinderResultPointCallback;
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.auto_focus) {
            ...
            if (order == CaptureActivity.REGISTER) {
                ...
                SampleApplication.mFaceDB.addFace(name, (AFR_FSDKFace) (message.obj), barcode);

                fragment.handleDecode("save face success", barcode);//���ؽ��
                /***********************************************************************/
            } else {
                fragment.handleDecode((String) message.obj, barcode);
            }
